...
class puppet (
  ...
  Optional[Array[String]] $server_cipher_suites = $puppet::params::server_cipher_suites,
  ...
  Optional[Array[String]] $server_ssl_protocols = $puppet::params::server_ssl_protocols,
